...
<div class="max-w-xl mx-auto space-y-6 pb-12">
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Create Staff Role</h1>
            <p class="text-xs text-slate-500 mt-0.5">Define a new employee access role (e.g. Warehouse Supervisor, Billing Staff).</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.roles.store') }}" method="POST" class="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 space-y-5">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                placeholder="e.g. Warehouse Supervisor, Sales Representative"
